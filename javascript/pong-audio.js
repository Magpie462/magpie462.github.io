...
export var wallSound = new soundFile("creepy-sound.mp3"); //load sound
soundArray.push(wallSound); //add sound to list of sounds

export var paddleSound = new soundFile("cinematic_reverb.mp3");
soundArray.push(paddleSound);

export var scoreSound = new soundFile("atmosphere.mp3");
...
export var adventureMusic = new soundFile("creepy-sound.mp3");
soundArray.push(adventureMusic);
adventureMusic.player.loop = true;
adventureMusic.player.volume.value = -16;

export var villageMusic = new soundFile("creepy-sound.mp3");
